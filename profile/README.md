...
**How it works:** change your module source from `terraform-aws-modules` to `soc2.compliance.tf` (or `pcidss`, `hipaa`, `nist`, `iso27001`, `gdpr`, `nis2`, `fedramp`, `cis`). Run `terraform init`. Done.

Works with Terraform, OpenTofu, Terragrunt, and Terramate. No new CLI, no policy agent, no sidecar.

🔗 [compliance.tf](https://compliance.tf) · [Docs](https://compliance.tf/docs/) · [Blog](https://compliance.tf/blog/) · [AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-piljg56ndgr2c)
